            ...
            <div className='grid mb-8 lg:grid-cols-6'>
                <div  className='grid grid-cols-2 gap-5 lg:col-span-4 md:grid-cols-4'>
                    ...
                    <div>
                        ...
                        <ul className='mt-2 space-y-2'>
                            <li>
                                <a href="/" className='text-gray-500 transition-colors duration-300 hover:text-orange-500'>Meida</a>
                            </li>
                            <li>
                ...
                <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
                    ...
                    <p className='mt-4 text-sm text-gray-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam ullam consequuntur at, consectetur facere quis repudiandae, libero nulla blanditiis ducimus autem perspiciatis expedita quod. Illo vel iusto error fugit animi?</p>
                </div>
            </div>
